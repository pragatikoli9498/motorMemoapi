...
{
    [Route("[controller]")]
    public class ReceiptReportController : ControllerBase
    {
        ...
        public readonly ReceiptProc _proc;
        public readonly CommanProc _comman;
        private respayload rtn = new respayload();
        public ReceiptReportController(IMemoryCache cache, IWebHostEnvironment environment, ReceiptProc proc, CommanProc comman)
        {
            _cache = cache;
        ...
        public async Task<IActionResult> Report([FromBody] Dictionary<string, object> jsonArray)
        {
            ...
            if (_reportCacheId != null)
            {
                ...
                string RdlPath = basePath + @"\\Models\\Rdlc\\Receipt.rdl";

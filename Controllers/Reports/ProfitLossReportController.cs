...
namespace MotorMemo.Controllers.Reports
{
    ...
    public class ProfitLossReportController : ControllerBase
    {
        ...
        public ProfitLossReportController(IMemoryCache cache, IWebHostEnvironment environment, ProfitLossProc proc, CommanProc comman)
        {
            _cache = cache;
        ...
        public async Task<IActionResult> Report([FromBody] Dictionary<string, object> jsonArray)
        {
            ...
            if (_reportCacheId != null)
            {
                ...
                string RdlPath = basePath + ((Convert.ToInt16(reportType) == 1) ? @"\\Models\\Rdlc\\ProfitLoss1.rdl" : @"\\Models\\Rdlc\\ProfitLoss2.rdl");

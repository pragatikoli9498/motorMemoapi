...
{
    [Route("[controller]")]
    public class MotorMemoRegReportController : ControllerBase
    {
        ...
        public MotorMemoRegReportController(IMemoryCache cache, IWebHostEnvironment environment, MotormemoRegProc proc, CommanProc comman)
        {
            _cache = cache;
        ...
        public async Task<IActionResult> Report([FromBody] Dictionary<string, object> jsonArray)
        {
            ...
            if (_reportCacheId != null)
            {
                ...
                string RdlPath = basePath + @"\\Models\\Rdlc\\motormemoreg1.rdl";

...
{
    [Route("[controller]")]
    public class BiltyReportController : ControllerBase
    {
        ...
        public readonly BiltyProc _proc;
        public readonly CommanProc _comman;
        private respayload rtn = new respayload();
        public BiltyReportController(IMemoryCache cache, IWebHostEnvironment environment, BiltyProc proc, CommanProc comman)
        {
            _cache = cache;
        ...
        public async Task<IActionResult> Report([FromBody] Dictionary<string, object> jsonArray)
        {
            ...
            if (_reportCacheId != null)
            {
                ...
                string RdlPath = basePath + @"\\Models\\Rdlc\\Bilty.rdl";

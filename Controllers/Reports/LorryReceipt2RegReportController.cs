...
{
    [Route("[controller]")]
    public class LorryReceipt2RegReportController : ControllerBase
    {
        ...
        public readonly LorryReceipt2RegProc _proc;
        public readonly CommanProc _comman;
        private respayload rtn = new respayload();
        public LorryReceipt2RegReportController(IMemoryCache cache, IWebHostEnvironment environment, LorryReceipt2RegProc proc, CommanProc comman)
        {
            _cache = cache;
        ...
        public async Task<IActionResult> Report([FromBody] Dictionary<string, object> jsonArray)
        {
            ...
            if (_reportCacheId != null)
            {
                ...
                string RdlPath = basePath + @"\\Models\\Rdlc\\LorryReceipt2Reg.rdl";

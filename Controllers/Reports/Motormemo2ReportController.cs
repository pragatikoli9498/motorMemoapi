...
{
    [Route("[controller]")]
    public class Motormemo2ReportController : ControllerBase
    {
        ...
        public Motormemo2ReportController(IMemoryCache cache, IWebHostEnvironment environment, motormemo2Proc proc, CommanProc comman)
        {
            _cache = cache;
        ...
        public async Task<IActionResult> Report([FromBody] Dictionary<string, object> jsonArray)
        {
            ...
            if (_reportCacheId != null)
            {
                ...
                string[] RpParamNames = new string[] {  };

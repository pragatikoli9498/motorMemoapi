...
{
    [Route("[controller]")]
    public class SundryWiseReportController : ControllerBase
    {
        ...
        public readonly SundryWiseProc _proc;
        public readonly CommanProc _comman;
        private respayload rtn = new respayload();
        public SundryWiseReportController(IMemoryCache cache, IWebHostEnvironment environment, SundryWiseProc proc, CommanProc comman)
        {
            _cache = cache;
        ...
        public async Task<IActionResult> Report([FromBody] Dictionary<string, object> jsonArray)
        {
            ...
            if (_reportCacheId != null)
            {
                ...
                string[] DbParamNames = new string[] { "firm_id", "div_id","s_id", "sdt", "edt" };
                ...
                string RdlPath = basePath + @"\\Models\\Rdlc\\Sundrywise.rdl";
                ...
                try
                {
                    ...
                    if (ReportData == null)
                    {
                        ...
                        object dataset1 = await _proc.Data(
                                                             ...
                                                             Convert.ToInt16(DbParamsWithValue["s_id"]),

...
{
    [Route("[controller]")]
    public class TransInvoiceReportController : ControllerBase
    {
        ...
        public readonly TransInvoiceProc _proc;
        public readonly CommanProc _comman;
        private respayload rtn = new respayload();
        public TransInvoiceReportController(IMemoryCache cache, IWebHostEnvironment environment, TransInvoiceProc proc, CommanProc comman)
        {
            _cache = cache;
        ...
        public async Task<IActionResult> Report([FromBody] Dictionary<string, object> jsonArray)
        {
            ...
            if (_reportCacheId != null)
            {
                ...
                string RdlPath = basePath + @"\\Models\\Rdlc\\TransInvoice.rdl";

...
{
    [Route("[controller]")]
    public class TransInvRegReportController : ControllerBase
    {
        ...
        public TransInvRegReportController(IMemoryCache cache, IWebHostEnvironment environment, TransInvoiceRegProc proc, CommanProc comman)
        {
            _cache = cache;
        ...
        public async Task<IActionResult> Report([FromBody] Dictionary<string, object> jsonArray)
        {
            ...
            if (_reportCacheId != null)
            {
                ...
                string[] DbParamNames = new string[] { "firm_id", "div_id", "sdt", "edt","accCode" };
                ...
                string RdlPath = basePath + @"\\Models\\Rdlc\\TraninvReg.rdl";
                ...
                try
                {
                    ...
                    if (ReportData == null)
                    {
                        ...
                        object dataset1 = await _proc.Data(
                                                             ...
                                                             Convert.ToInt16(DbParamsWithValue["accCode"])
                                              );

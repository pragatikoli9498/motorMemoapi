...
{
    [Route("[controller]")]
    public class SubGroupListReportController : ControllerBase
    {
        ...
        public SubGroupListReportController(IMemoryCache cache, IWebHostEnvironment environment, SubGroupListProc proc, CommanProc comman)
        {
            _cache = cache;
        ...
        public async Task<IActionResult> Report([FromBody] Dictionary<string, object> jsonArray)
        {
            ...
            if (_reportCacheId != null)
            {
                ...
                string[] DbParamNames = new string[] { "firm_id", "div_id", "sg_code", "sdt", "edt" };
                ...
                string RdlPath = basePath + @"\\Models\\Rdlc\\Sub_Group_List.rdl";

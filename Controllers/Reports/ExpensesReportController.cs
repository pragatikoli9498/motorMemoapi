...
namespace MotorMemo.Controllers.Reports
{
    ...
    public class ExpensesReportController : ControllerBase
    {
        ...
        public readonly ExpensesProc _proc;
        public readonly CommanProc _comman;
        private respayload rtn = new respayload();
        public ExpensesReportController(IMemoryCache cache, IWebHostEnvironment environment, ExpensesProc proc, CommanProc comman)
        {
            _cache = cache;
        ...
        public async Task<IActionResult> Report([FromBody] Dictionary<string, object> jsonArray)
        {
            ...
            if (_reportCacheId != null)
            {
                ...
                string RdlPath = basePath + @"\\Models\\Rdlc\\Expenses.rdl";
